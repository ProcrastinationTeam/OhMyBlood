...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		type.set ("assets/data/fullMap.ase", AssetType.BINARY);
		path.set ("assets/data/fullMap.png", "assets/data/fullMap.png");
		type.set ("assets/data/fullMap.png", AssetType.IMAGE);
		path.set ("assets/data/fullMap2.ase", "assets/data/fullMap2.ase");
		type.set ("assets/data/fullMap2.ase", AssetType.BINARY);
		path.set ("assets/data/fullMap2.png", "assets/data/fullMap2.png");
		type.set ("assets/data/fullMap2.png", AssetType.IMAGE);
		path.set ("assets/data/level0.png", "assets/data/level0.png");
		type.set ("assets/data/level0.png", AssetType.IMAGE);
		...
		type.set ("assets/data/testMap.ase", AssetType.BINARY);
		path.set ("assets/data/testMap.png", "assets/data/testMap.png");
		type.set ("assets/data/testMap.png", AssetType.IMAGE);
		path.set ("assets/data/testMap2.ase", "assets/data/testMap2.ase");
		type.set ("assets/data/testMap2.ase", AssetType.BINARY);
		path.set ("assets/data/testMapB.ase", "assets/data/testMapB.ase");
		type.set ("assets/data/testMapB.ase", AssetType.BINARY);
		...
		type.set ("assets/images/galletvania_example.png", AssetType.IMAGE);
		path.set ("assets/images/galletvania_tiles.png", "assets/images/galletvania_tiles.png");
		type.set ("assets/images/galletvania_tiles.png", AssetType.IMAGE);
		path.set ("assets/images/hero - Copie.png", "assets/images/hero - Copie.png");
		type.set ("assets/images/hero - Copie.png", AssetType.IMAGE);
		path.set ("assets/images/hero.ase", "assets/images/hero.ase");
		type.set ("assets/images/hero.ase", AssetType.BINARY);
		path.set ("assets/images/hero.png", "assets/images/hero.png");
		type.set ("assets/images/hero.png", AssetType.IMAGE);
		...
		type.set ("assets/images/MisterDougy.png", AssetType.IMAGE);
		path.set ("assets/images/tiles.png", "assets/images/tiles.png");
		type.set ("assets/images/tiles.png", AssetType.IMAGE);
		path.set ("assets/images/tilesInvert.png", "assets/images/tilesInvert.png");
		type.set ("assets/images/tilesInvert.png", AssetType.IMAGE);
		...
		id = "assets/data/fullMap.ase";
		path.set (id, id);
		type.set (id, AssetType.BINARY);
		id = "assets/data/fullMap.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/data/fullMap2.ase";
		path.set (id, id);
		type.set (id, AssetType.BINARY);
		id = "assets/data/fullMap2.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/data/level0.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/data/level1.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/data/testMap.ase";
		path.set (id, id);
		type.set (id, AssetType.BINARY);
		id = "assets/data/testMap.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/data/testMap2.ase";
		path.set (id, id);
		type.set (id, AssetType.BINARY);
		id = "assets/data/testMapB.ase";
		path.set (id, id);
		type.set (id, AssetType.BINARY);
		...
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/galletvania_example.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/galletvania_tiles.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/hero - Copie.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/hero.ase";
		path.set (id, id);
		type.set (id, AssetType.BINARY);
		id = "assets/images/hero.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		...
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/MisterDougy.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/tiles.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
		id = "assets/images/tilesInvert.png";
		path.set (id, id);
		type.set (id, AssetType.IMAGE);
